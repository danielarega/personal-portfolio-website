      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">MADDA WALABU UNIVERSITY • june-august 2025</p>
            <ul className="text-secondary list-disc list-inside space-y-2">
              <li>Developed and maintained RESTful APIs</li>
              <li>Built responsive user interfaces with modern JavaScript frameworks like React</li>
      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">ARSI UNIVERSITY• 2023 - 2026</p>
            <p className="text-secondary">
              Graduated with honors. Focused on Network engineering and web development.
            </p>
          </motion.div>
        </motion.div>
      </motion.section>
