  ...
  return (
    ...
    >
      ...
      transition={{duration:0.6, delay:0.8}}
        ...
        className='flex-1'>
          <p className='mb-10 max-w-2xl font-ovo'>i am a junoir frontend developer with over a one years of learning expertise in the field throughtout my university period,</p>
          <motion.ul 
 initial={{opacity:0}}
whileInView={{opacity:1}}
