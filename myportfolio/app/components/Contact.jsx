...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "6da6191b-29a5-4e37-baf2-9f8a97642f1c");
...
return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            <button type="submit" className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500'>submit now <Image src={assets.right_arrow_white} alt='rightarrow' className='w-4' width={16} height={16} /></button>
            <p className='mt-4'>
            {result}  
            </p>
        </form>
