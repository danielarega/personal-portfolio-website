  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center  justify-center gap-4'>
      <div>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'> Hi! I'm Daniel Arega <Image src={assets.hand_icon} alt="handicon" className=' w-6' /></h3>
...
<a href="/myresume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>my resume <Image src={assets.download_icon} alt="" className=' w-4' /></a>
