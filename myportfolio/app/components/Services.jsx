...
import {sevicesData} from '../../assets/assets'
export default function Services() {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
    <h4 classNam      e='text-center mb-2 text-lg font-ovo'>what i offer</h4>
      <h2 className='text-center text-5xl font-ovo'>my services</h2>

      <p className='text-center max-w-2xl mx-auto mt-5 mb-12   font-ovo'>i am frontend developer from ethiopia with zero year of experience in multiple companies like arsi university, gebeya.com.</p>
